...
class HospitalMetge(models.Model):
    ...
    pacient = fields.Many2one('hospital.paciente',"Pacientes")
    metge = fields.Many2one('hospital.metge',"Metge")
    diagnostic = fields.Char('Diagnostic', required=True, index=True)
